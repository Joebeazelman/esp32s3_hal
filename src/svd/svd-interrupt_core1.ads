...
package SVD.INTERRUPT_CORE1 is
   pragma Preelaborate;
   ...
   type DATE_Register is record
      --  version register
      INTERRUPT_DATE : SVD.UInt28 := 16#2012300#;
      --  unspecified
   ...
   type INTERRUPT_CORE1_Peripheral is record
      ...
      APP_INTR_STATUS_0                            : aliased SVD.UInt32;
      --  interrupt status register
      APP_INTR_STATUS_1                            : aliased SVD.UInt32;
      --  interrupt status register
      APP_INTR_STATUS_2                            : aliased SVD.UInt32;
      --  interrupt status register
      APP_INTR_STATUS_3                            : aliased SVD.UInt32;
      --  clock gate register
